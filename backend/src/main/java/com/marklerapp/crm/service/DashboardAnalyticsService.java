...
public class DashboardAnalyticsService {
    ...
    public DashboardAnalyticsDto generateAnalytics(UUID agentId) {
        ...
        return DashboardAnalyticsDto.builder()
                ...
                .leadSourcePerformance(calculateLeadSourcePerformance(agent))
     ...
     */
    private List<LeadSourcePerformanceDto> calculateLeadSourcePerformance(Agent agent) {
        Map<String, List<Client>> bySource = clientRepository.findByAgent(agent).stream()
